...
person_df2 <- person_df1 <- read.csv("tidynomicon/person.csv",stringsAsFactors = FALSE)
str(person_df2)
...
voter_turnout_df1 <- read_excel('G04ResultsDetail2004-11-02.xls',skip=1)
...
voter_turnout_df2 <- read_excel("G04ResultsDetail2004-11-02.xls",sheet='Voter Turnout',skip=1)
